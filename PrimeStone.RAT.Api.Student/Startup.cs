...
namespace PrimeStone.RAT.Api.Student
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "PrimeStone.RAT.Api.Student", Version = "v1" });
                // Activar Autorizacion JWT en Swagger    
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "PrimeStone.RAT.Api.Student v1"));
            }
